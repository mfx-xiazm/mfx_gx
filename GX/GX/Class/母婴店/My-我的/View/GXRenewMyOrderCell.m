...
-(void)setRefund:(GXMyRefund *)refund
{
    ...
    self.goods_num.text = [NSString stringWithFormat:@"购买x%@ 退款x%@",_refund.goods_num,(_refund.return_num && _refund.return_num.length)?_refund.return_num:_refund.goods_num];
}
