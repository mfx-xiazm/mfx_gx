...
@interface GXMyCouponVC ()<JXCategoryViewDelegate,UIScrollViewDelegate,UITextFieldDelegate>
...
-(NSArray *)childVCs
{
    if (_childVCs == nil) {
        ...
        for (int i=0;i<self.categoryView.titles.count;i++) {
            GXMyCouponChildVC *cvc0 = [GXMyCouponChildVC new];
...
-(void)setUpCategoryView
{
    ...
    _categoryView.titles = @[@"可领取", @"可使用", @"已使用"];
