...
-(void)getCouponListRequest:(BOOL)isRefresh
{
    ...
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:@"index/getCouponList" parameters:parameters success:^(id responseObject) {
        hx_strongify(weakSelf);
...
-(void)drawCouponRequest:(GXMyCoupon *)coupon
{
    ...
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:@"index/drawCoupon" parameters:parameters success:^(id responseObject) {
        hx_strongify(weakSelf);
        if([[responseObject objectForKey:@"status"] integerValue] == 1) {
