...
-(void)forgetPasswordRequest:(UIButton *)btn
{
    ...
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:(self.dataType ==1)?@"program/forgetPassword":@"program/editPassword" parameters:parameters success:^(id responseObject) {
        hx_strongify(weakSelf);
