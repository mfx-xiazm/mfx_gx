...
{
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:@"program/selectShop" parameters:@{} success:^(id responseObject) {
        hx_strongify(weakSelf);
...
-(void)getCatalogShopRequest:(BOOL)isRefresh
{
    ...
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:@"program/getCatalogShop" parameters:parameters success:^(id responseObject) {
        hx_strongify(weakSelf);
