...
-(void)getMaterialFilterDataRequest
{
    ...
    dispatch_group_async(group, queue, ^{
        ...
        [HXNetworkTool POST:HXRC_M_URL action:@"program/materialGood" parameters:@{} success:^(id responseObject) {
    ...
    dispatch_group_async(group, queue, ^{
        ...
        [HXNetworkTool POST:HXRC_M_URL action:@"program/materialData" parameters:@{} success:^(id responseObject) {
            if([[responseObject objectForKey:@"status"] integerValue] == 1) {
...
-(void)getMaterialListDataRequest:(BOOL)isRefresh completedCall:(void(^)(void))completedCall
{
    ...
    hx_weakify(self);
    [HXNetworkTool POST:HXRC_M_URL action:@"program/materialList" parameters:parameters success:^(id responseObject) {
        hx_strongify(weakSelf);
        if([[responseObject objectForKey:@"status"] integerValue] == 1) {
            if (isRefresh) {
